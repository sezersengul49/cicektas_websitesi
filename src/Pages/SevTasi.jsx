 ...
 <>
    ...
    <div className="container mx-auto p-6 md:p-10 bg-gray-50">
      ...
      <p className="text-lg text-gray-700 mb-6 px-14 leading-relaxed">
        Şev Taşı, otoyol veya bahçe gibi mekanlarda toprak kaymasını engellemek
        ve dik eğimli yamaçlarda oluşabilecek sel felaketlerini önlemede
        kullanılan beton ürünüdür. Toprak tutuculuğunun yanı sıra bahçe ve
        peyzaj çalışmalarında istinat duvarı amaçlıda kullanılabilir. Birbirine
        kitleme yapılarak uygulanan şev taşı, yüksek yamaçlardaki eğimlerde
        perde görevi sağlar. Şev Taşı fiyatları için firmamızla iletişime
        geçiniz.
      </p>
