...
const OlukTasi5 = () => {
  return (
    <>
      <Helmet>
        <title>Oluk Taşı 25x33- Çicek Taş Üst Yapı elemanları</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="oluk taşı, 25x33 oluk taşı, yağmur oluk taşı, drenaj taşları, peyzaj çözümleri"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.example.com/oluk-tasi-25x33" />
      </Helmet>
