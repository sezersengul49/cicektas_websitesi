...
const OlukTasi4 = () => {
  return (
    <>
      <Helmet>
        <title>Oluk Taşı 25x30  - Dayanıklı ve Estetik Drenaj Çözümleri | Çiçek Taş Beton</title>
        <meta
          name="description"
        ...
        <meta property="og:url" content="https://www.cicektasbeton.com/oluk-tasi-25x30" />
      ...
      <div className="container mx-auto p-6 md:p-10 bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          <img
            src="/oluk-tası6.webp"
            alt="25x30 Oluk Taşı - Dayanıklı ve estetik drenaj çözümü"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
          <img
            src="/oluk-tası4.webp"
            alt="25x30 Oluk Taşı - Pratik ve hızlı uygulanabilir"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <img
            src="/oluk-tası2.webp"
            alt="25x30 Oluk Taşı - Çeşitli renk ve desen seçenekleri"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
          <img
            src="/oluk-tası4.webp"
            alt="25x30 Oluk Taşı - Estetik ve dayanıklı"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
        </div>
