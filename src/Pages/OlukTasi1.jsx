...
const OlukTasi1 = () => {
  return (
    <>
      <Helmet>
        <title> Oluk Taşı 20x20 - Dayanıklı ve Estetik Drenaj Çözümleri | Çiçek Taş Beton</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="20x20 Oluk Taşı - Dayanıklı ve Estetik Drenaj Çözümleri | Çiçek Taş Beton" />
        <meta
      ...
      <div className="container mx-auto p-6 md:p-10 bg-gray-50">
        ...
        <ul className="list-disc pl-[40px] text-gray-700 mb-10 leading-loose">
          ...
          <li>Metreye 5 adet 20X20 yağmur oluğu kullanılır.</li>
          <li>Bir palette 180 adet 20X20 yağmur oluğu bulunmaktadır.</li>
