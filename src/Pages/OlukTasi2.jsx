...
const OlukTasi2 = () => {
  return (
    <>
      <Helmet>
        <title> Oluk Taşı 20x30 - Dayanıklı ve Estetik Drenaj Çözümleri | Çiçek Taş Beton</title>
        <meta
          name="description"
          content="20x30 Oluk Taşı, Çiçek Taş Beton'un kaliteli ve dayanıklı beton taşları ile drenaj çözümleri sunar. Bahçe, yol ve kaldırım düzenlemeleri için ideal bir seçenek. Hemen keşfedin!"
        />
        <meta
          name="keywords"
          content="20x30 oluk taşı, oluk taşı, drenaj taşı, kaldırım taşı, bahçe taşı, Çiçek Taş, beton elemanları, çiçek taş beton"
        />
        <meta property="og:title" content="20x30 Oluk Taşı - Dayanıklı ve Estetik Drenaj Çözümleri | Çiçek Taş Beton" />
        <meta
          property="og:description"
          content="20x30 Oluk Taşı, Çiçek Taş Beton'un kaliteli ve dayanıklı beton taşları ile drenaj çözümleri sunar. Bahçe, yol ve kaldırım düzenlemeleri için ideal bir seçenek. Hemen keşfedin!"
        />
        <meta property="og:image" content="https://www.cicektasbeton.com/oluk-tası6.webp" />
        <meta property="og:url" content="https://www.cicektasbeton.com/oluk-tasi-20x30" />
        <meta property="og:type" content="website" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.cicektasbeton.com/oluk-tasi-20x30" />
      </Helmet>
      ...
      <div className="container mx-auto p-6 md:p-10 bg-gray-50">
        ...
        <p className="text-lg text-gray-700 mb-6 px-14 leading-relaxed">
          ...
          yönlendirilmesi ve drenaj sağlaması için ideal bir çözümdür. 20X30
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          <img
            src="/oluk-tası6.webp"
            alt="20x30 Oluk Taşı - Dayanıklı ve estetik drenaj çözümü"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
          <img
            src="/oluk-tası4.webp"
            alt="20x30 Oluk Taşı - Pratik ve hızlı uygulanabilir"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
        </div>
        ...
        <ul className="list-disc pl-[100px] text-gray-700 mb-10 leading-loose">
          ...
          <li>Metreye 5 adet 20X30 yağmur oluğu kullanılır.</li>
          <li>Bir palette 160 adet 20X30 yağmur oluğu bulunmaktadır.</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <img
            src="/oluk-tası2.webp"
            alt="20x30 Oluk Taşı - Çeşitli renk ve desen seçenekleri"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
          <img
            src="/oluk-tası4.webp"
            alt="20x30 Oluk Taşı - Estetik ve dayanıklı"
            className="w-full max-w-[350px] h-[350px] rounded-lg shadow-lg mx-auto"
            loading="lazy"
          />
        </div>
